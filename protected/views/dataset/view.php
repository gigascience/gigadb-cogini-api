...
<div class="row">
    ...
    <? echo MyHtml::link("View Next Dataset",'/dataset/next?doi='.$model->identifier,array('class'=>'span2 btn-green')) ?>
...
<?}
?>
                <th class="span2">FTP</th>
                <th class="span2">Send to GigaGalaxy</th>
            </thead>
            <!--/tr-->
            <?
            ...
            foreach ($files->getData() as $file) {
                ...
                <tr>
                    ...
                    <td><?php $form=$this->beginWidget('CActiveForm', array(
                            'action'=>'http://localhost:8080/tool_runner?tool_id=gigadb&amp;type=text&amp;name=Gigadb'.$model->identifier.': '.$file->name.'&amp;URL='.$file->location,
                            'method'=>'post',
                            )); ?>
                            <div class="row buttons">
                                    <?php echo CHtml::submitButton('Send to GigGalaxy'); ?>
                            </div>
                            <?php $this->endWidget(); ?>
                    </td>
                </tr>
...
<h1>comments</h1> For comment guidelines <a href="/site/help">see here</a>
